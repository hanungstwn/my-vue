<template>
  <v-form>
    <v-row>
      <!-- <h1>History Data Customer {{ $route.params.id }}</h1> -->
      <v-card-text>
        <v-container>
                      ...
                      <v-row>
                        <v-col cols="12" sm="6" md="6">
                          ...
                          <v-text-field
                            ...
                            outlined
                            required
                            v-model="checkoutDataEntry.quantity"></v-text-field>
                          <v-text-field
                            label="Berat /Produk"
                            hint="Weight /product"
                            outlined
                        ...
                        <v-col cols="12" sm="6" md="6">
                          ...
                          <v-text-field
                            ...
                            outlined
                            required
                            v-model="checkoutDataEntry.sumPrice"></v-text-field>
                          <v-text-field
                            label="Diskon"
                            hint="example of helper text only on focus"
                            outlined
                            required
                            v-model="checkoutDataEntry.discount"></v-text-field>
                          <v-text-field
                            label="Total Harga"
                            hint="example of helper text only on focus"
                            outlined
          ...
          <v-container class="button-wrapper">
            <v-btn depressed class="me-4" color="error" dark @click="cancelUpdate"
            >Cancel</v-btn
            >
            <v-btn depressed color="success" @click="updateData"> Save </v-btn>
          </v-container>
        </v-container>
      </v-card-text>
    </v-row>
